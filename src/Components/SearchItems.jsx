...
export default function SearchItems(props) {
  function hover_this_item(){
    if (window.innerWidth > 821) {
        ...
        document.getElementById("for_search_container"+props.class_key).style.height = "auto"
        document.getElementById("for_search_container"+props.class_key).style.zIndex = "1"
  ...
  function out_hover_this_item(){
    ...
    if (window.innerWidth > 821) {
      document.getElementById("for_search_container"+props.class_key).style.position = "relative"
      document.getElementById("for_search_container"+props.class_key).style.marginTop = "0px"
